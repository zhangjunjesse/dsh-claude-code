...
function WindowRow({ label, window: window2, soon }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: CSS.usageRow, children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: CSS.usageRowLabel, children: label }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
      "span",
      {
        ...
        "aria-valuemin": 0,
        "aria-valuemax": 100,
        children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: fillClass(percent), style: { width: `${percent}%` } })
      }
    ),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: CSS.usageRowMeta, children: [
      shown,
...
function UsageBar({ usage, loading, error, onRefresh }) {
  const refresh = /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
    "button",
    {
      type: "button",
  ...
  if (failure !== null) {
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: CSS.usage, role: "status", "aria-label": t("usage.title"), children: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: CSS.usageHead, children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: CSS.usageError, children: tf("usage.failed", failure) }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: CSS.usageSpacer }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { type: "button", className: CSS.usageRefresh, disabled: loading, onClick: onRefresh, children: loading ? t("usage.refreshing") : t("usage.retry") })
    ] }) });
  }
  if (usage === null) {
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: CSS.usage, role: "status", "aria-label": t("usage.title"), children: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: CSS.usageHead, children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: CSS.usageNote, children: t("usage.loading") }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: CSS.usageSpacer }),
      refresh
    ] }) });
  }
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: CSS.usage, role: "status", "aria-label": t("usage.title"), children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: CSS.usageHead, children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: CSS.usagePlan, children: formatPlan(usage.subscription.type) }),
      tier === null ? null : /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: CSS.usageTier, children: [
        "\xB7 ",
        tier
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: usage.cache.maybeStale ? `${CSS.usageCache} ${CSS.usageStale}` : CSS.usageCache, children: cacheLabel(usage) }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: CSS.usageSpacer }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: BADGE_CLASS[usage.advice], children: t(BADGE_KEY[usage.advice]) }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: CSS.usageAdvice, children: t(ADVICE_KEY[usage.advice]) }),
      refresh
    ] }),
    usage.loggedIn ? null : /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: CSS.usageNote, children: t("usage.loggedOut") }),
    hasWindows ? /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: CSS.usageBars, children: [
      usage.fiveHour === null ? null : /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(WindowRow, { label: t("usage.fiveHour"), window: usage.fiveHour, soon: true }),
      usage.sevenDay === null ? null : /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(WindowRow, { label: t("usage.sevenDay"), window: usage.sevenDay, soon: false })
    ] }) : /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: CSS.usageNote, children: t("usage.noData") }),
    scoped.length === 0 ? null : /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: CSS.usageChips, children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: CSS.usageChipsLabel, children: t("usage.scoped") }),
      scoped.map((limit) => /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: CSS.usageChip, children: [
        limit.scopeModel,
        " ",
...
function createClaudeCodeView(api) {
  return function ClaudeCodeView({ sessionId, useSessions }) {
    ...
    const rows = (0, import_react4.useMemo)(() => ordered(mirrored.filter((job) => job.kind === JOB_KIND)), [mirrored]);
    const panel = panelOf(sessionId);
    const [selected, setSelected] = (0, import_react4.useState)(() => panel.selected ?? defaultSelection(rows));
    const [meta, setMeta] = (0, import_react4.useState)({});
    ...
    const bumpRef = (0, import_react4.useRef)(() => {
    ...
    const onCancel = (0, import_react4.useCallback)((jobId) => {
      if (!window.confirm(t("action.cancel.confirm"))) return;
      api.cancel(sessionId, jobId).catch((failure) => {
        setError(`${t("error.prefix")}: ${failure instanceof Error ? failure.message : String(failure)}`);
      });
    }, [sessionId]);
    const flashCopied = (0, import_react4.useCallback)((token) => {
      setCopied(token);
      window.setTimeout(() => {
    ...
    void revision;
    const usageBar = /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(UsageBar, { usage: usage.usage, loading: usage.loading, error: usage.error, onRefresh: usage.refresh });
    if (rows.length === 0) {
      return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: CSS.root, "data-conversation-composer-overlay": "", children: [
        usageBar,
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: CSS.empty, children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: CSS.emptyTitle, children: t("list.empty.title") }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { children: t("list.empty.hint") }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { children: t("list.empty.note") })
        ] })
      ] });
    }
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: CSS.root, "data-conversation-composer-overlay": "", children: [
      usageBar,
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: CSS.body, children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: CSS.list, role: "tablist", "aria-label": t("list.title"), children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: CSS.listTitle, children: t("list.title") }),
          rows.map((job) => {
            ...
            return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: CSS.rowHead, children: [
                    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_dsh_client_ui_primitives.StateDot, { state: dotState(job.status), className: CSS.dot }),
                    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: CSS.rowLabel, title: job.label, children: job.label })
                  ] }),
                  /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: CSS.rowMeta, children: [
                    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { children: statusLabel(job.status) }),
                    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { children: formatDuration2(elapsed) }),
                    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: CSS.mono, children: job.id })
                  ] })
                ]
              },
              job.id
        ...
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: CSS.pane, children: current === void 0 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: CSS.empty, children: t("select.empty") }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: CSS.paneHead, children: [
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: CSS.paneTitle, title: detail?.task ?? current.label, children: current.label }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: CSS.stats, children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: CSS.stat, children: [
                t("detail.job"),
                ": ",
                /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: CSS.mono, children: current.id })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: CSS.stat, children: statusLabel(current.status) }),
              detail?.numTurns !== void 0 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: CSS.stat, children: [
                detail.numTurns,
                " ",
                t("stats.turns")
              ] }) : null,
              detail?.costUsd !== void 0 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: CSS.stat, children: [
                t("stats.cost"),
                " $",
              ...
              detail?.claudeSessionId !== void 0 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: CSS.stat, title: t("detail.session.hint"), children: [
                t("detail.session"),
                ": ",
                /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: CSS.mono, children: detail.claudeSessionId })
              ] }) : null
            ] }),
            current.detail !== void 0 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: CSS.stats, children: current.detail }) : null
          ] }),
          error !== null ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: CSS.error, children: error }) : null,
          events !== void 0 && events.list.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
            EventView,
            {
              jobId: current.id,
              events: events.list,
          ...
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: CSS.actions, children: [
            isLive(current) ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { type: "button", className: `${CSS.button} ${CSS.danger}`, onClick: () => {
              onCancel(current.id);
